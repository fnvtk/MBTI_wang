...
Page({
  ...
  handleWithdraw() {
    ...
    if (balance < 1) {
      tt.showToast({ title: '余额不足1元，暂无法提现', icon: 'none' })
      return
    }
  ...
  /** 生成海报 */
  generatePoster() {
    tt.navigateTo({ url: '/pages/promo/poster' })
  },

  /** 分享到朋友圈：引导用户使用右上角菜单 */
  shareToTimeline() {
    tt.showToast({ title: '请点击右上角 ··· 选择「分享到朋友圈」', icon: 'none', duration: 2500 })
  },
