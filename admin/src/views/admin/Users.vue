        ...
        <div v-if="currentTestType === 'mbti' && mbtiDetail" class="detail-section test-detail-mbti">
          ...
          <div class="test-detail-grid">
            ...
            <div class="test-detail-block" v-if="mbtiDetail.weaknesses?.length">
              <h4 class="detail-subtitle">潜在���板</h4>
...
.coop-title { font-size: 13px; font-weight: 500; color: #111827; }
.coop-code  { font-size: 12px; color: #6b7280; }
.coop-time  { font-size: 12px; color: #9ca3af; }
.coop-empty { color: #d1d5db; }
...
.user-info-cell {
  ...
  .user-details {
    .username   { font-weight: 600; color: #111827; font-size: 14px; margin-bottom: 2px; }
    .role-label { font-size: 12px; color: #9ca3af; }
  }
}
...
.contact-cell {
  ...
  .email      { color: #9ca3af; font-size: 12px; }
}
...
.test-results {
  ...
  .result-tag { font-size: 12px; cursor: pointer; }
  ...
  .no-test { font-size: 13px; color: #9ca3af; }
}
...
.payment-cell { font-size: 13px; color: #111827; }
